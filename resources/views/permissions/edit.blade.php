        ...
        <div class="w-full px-6 py-4 bg-white sm:rounded-lg shadow-md ">
            ...
            <form method="POST" action="{{ route('permission-plus.permissions.update', $permission->id) }}">
                ...
                <div class="mt-4">
                    ...
                    <div class="flex justify-start space-x-4">
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input form-check-input appearance-none  h-4 w-4 border border-gray-300 bg-white checked:bg-blue-600 checked:border-blue-600 focus:outline-none transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain float-left mr-2 cursor-pointer" type="checkbox" name="methods[]" value="{{ $method }}" {{ in_array($method, $permission->methods) ? 'checked':'' }} >
                ...
                <div class="mt-4">
                    ...
                    <input class="block w-full mt-1 border-gray-300 rounded-md shadow-sm placeholder:text-gray-400 placeholder:text-right focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" type="text" name="uri"  value="{{old('uri', $permission->uri)}}">
                    @error('uri')
                    <span class="text-red-600 text-sm">
                        {{ $message }}
                    </span>
                ...
                <div class="mt-4">
                   <x-permission-plus::label>Route Name</x-permission-plus::label>
                    ...
                    <input class="block w-full mt-1 border-gray-300 rounded-md shadow-sm placeholder:text-gray-400 placeholder:text-right focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" type="text" name="route_name" value="{{old('route_name', $permission->route_name)}}">
                    @error('route_name')
                    <span class="text-red-600 text-sm">
                        {{ $message }}
                    </span>
                ...
                <div class="mt-4">
                   <x-permission-plus::label>Action Name</x-permission-plus::label>
                    ...
                    <textarea name="action_name" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm placeholder:text-gray-400 placeholder:text-right focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" rows="4" placeholder="400">{{old('action_name', $permission->action_name)}}</textarea>
                    @error('action_name')
                    <span class="text-red-600 text-sm">
                        {{ $message }}
                    </span>
                ...
                <div class="mt-4" id="allow-guest-section">
                    ...
                    <div class="flex justify-start space-x-4">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input form-check-input appearance-none rounded-full h-4 w-4 border border-gray-300 bg-white checked:bg-blue-600 checked:border-blue-600 focus:outline-none transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain float-left mr-2 cursor-pointer" type="radio" name="allow_guest" value="1" {{ old('allow_guest', $permission->allow_guest) ===1 ? 'checked':'' }} >
                            <label class="form-check-label inline-block text-gray-800" for="inlineRadio10">Yes</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input form-check-input appearance-none rounded-full h-4 w-4 border border-gray-300 bg-white checked:bg-blue-600 checked:border-blue-600 focus:outline-none transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain float-left mr-2 cursor-pointer" type="radio" name="allow_guest" value="0" {{ old('allow_guest', $permission->allow_guest) ===0 ? 'checked':'' }} >
                            <label class="form-check-label inline-block text-gray-800" for="inlineRadio20">No</label>
                        </div>
                ...
                <div class="mt-4" id="roles-section">
                    ...
                    <div class="form-check">
                        <input class="form-check-input appearance-none h-4 w-4 border border-gray-300 rounded-sm bg-white checked:bg-blue-600 checked:border-blue-600 focus:outline-none transition duration-200  align-top bg-no-repeat bg-center bg-contain float-left mr-2 cursor-pointer mt-1" type="checkbox" value="{{ $role->id }}" name="roles[]" {{ old('roles', $permission->roles->contains('id', $role->id)) ? 'checked':'' }}>
...
<script>
let currAllowAll = document.querySelector('input[name="allow_all"]:checked').value;
onAllowAllClick(currAllowAll)
